...
package com.viewsforandroid.foundry.sample.ui.widget;
...
/**
 * Source code based on AnimatedMuzeiLogoView written by Roman Nurik.
 */
public class AnimatedLogoView extends View {
    private static final String TAG = AnimatedLogoView.class.getSimpleName();
    ...
    private static final int TRACE_RESIDUE_COLOR = Color.argb(50, 51, 51, 51);
    private static final int TRACE_COLOR = Color.RED;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (t > FILL_START) {
            ...
            mFillPaint.setARGB((int) (phase * 255), 51, 51, 51);
